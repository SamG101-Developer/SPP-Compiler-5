...
if TYPE_CHECKING:
    ...
    from SPPCompiler.SemanticAnalysis.GenericParameterAst import GenericParameterRequiredAst, GenericParameterOptionalAst, GenericParameterVariadicAst
    from SPPCompiler.SemanticAnalysis.GenericParameterAst import GenericCompParameterAst, GenericTypeParameterAst
