...
class AstFunctions:
    ...
    def get_function_owner_type_and_function_name(
        ...
        @param scope_manager The scope manager to access function scopes.
    ...
    def convert_method_to_function_form(
            scope_manager: ScopeManager, function_owner_type: Ast, function_name: Asts.IdentifierAst,
    ...
    def name_function_arguments(
        ...
        @raises
            * SemanticErrors.ArgumentNameInvalidError: If an argument name is invalid (doesn't match a parameter name).
        """
    ...
    def name_generic_arguments(
        ...
        @raises
            * SemanticErrors.ArgumentNameInvalidError: If an argument name is invalid (doesn't match a parameter name).
            * SemanticErrors.GenericArgumentTooManyError: If too many generic arguments are passed.
        """
    ...
    def infer_generic_arguments(
        ...
        @raises
            * SemanticErrors.GenericParameterInferredConflictInferredError: If the inferred generic arguments conflict.
            * SemanticErrors.GenericParameterInferredConflictExplicitError: If the inferred generic arguments conflict
                with explicit generic arguments.
            * SemanticErrors.GenericParameterNotInferredError: If a generic parameter has not been inferred.
