...
class FunctionCallArgumentUnnamedAst(Ast, Ordered, TypeInferrable, CompilerStages):
    ...
    _type_from_self: Asts.InferredType = field(default=None, init=False, repr=False)
    ...
    @staticmethod
    def from_value(value: Asts.ExpressionAst) -> FunctionCallArgumentUnnamedAst:
        return FunctionCallArgumentUnnamedAst(-1, Asts.ConventionMovAst(), None, value)
